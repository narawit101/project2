...
export default function Booking() {
  ...
  function isSlotBooked(slot) {
    ...
    // If the end time is earlier than the start time, adjust the end time to the next day
    if (slotEnd <= slotStart) {
      slotEnd.setDate(slotEnd.getDate() + 1); // Move end time to the next day
    }
    ...
    for (let booking of bookedSlots) {
      ...
      // Adjust the booking end time to the next day if necessary
