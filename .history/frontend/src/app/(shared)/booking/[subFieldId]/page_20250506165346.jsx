    ...
    <div>
      ...
      <div className="container-bookings">
        ...
        <div className="book-sider">
          ...
          {subFieldData !== "ไม่พบข้อมูล" && subFieldData?.sub_field_name ? (
  <div className="sub-name-book">
    <h2>{subFieldData.sub_field_name}</h2>
  </div>
) : (
  <h2>{subFieldData}</h2>
)}
            ...
            <strong>เวลาเริ่ม: {timeStart || "-"} น </strong>
            <strong>เวลาสิ้นสุด: {timeEnd || "-"} น </strong>
            <strong>รวมเวลา: {totalHours ? `${totalHours} ชั่วโมง` : "-"}</strong>

           
            <strong>{`มัดจำที่ต้องจ่าย ${priceDeposit} บาท`}</strong>
            ...
            <strong>{`ยอดรวมสุทธิ ${totalRemaining} บาท`}</strong>
          </div>
