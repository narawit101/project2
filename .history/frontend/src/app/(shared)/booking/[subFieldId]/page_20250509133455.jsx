...
export default function Booking() {
  ...
  return (
    <div>
      <h1 className="select-time-book">เลือกช่วงเวลา
      <div className="sum-status-box-boook">
          <div className="status-box-book-1">1
            <label>ว่าง</label>
          </div>
        
          <div className="status-box-book-2">รอตรวจสอบ</div>
          <div className="status-box-book-3">ติดจอง</div>
        </div>
      </h1>
