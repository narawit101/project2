...
export default function Booking() {
  ...
  function isSlotBooked(slot) {
    ...
    if (slotEnd.getTime() <= slotStart.getTime()) {
      // ถ้า end คือ 00:00 แสดงว่าต้องข้ามวัน (เช่น 23:00 - 00:00)
      // ดังนั้นต้องบวก 1 วันให้ endTime
  ...
  function calculateSelectedTimes() {
    ...
    // ปรับเงื่อนไขให้รองรับกรณี "00:00" อย่างถูกต้อง
    if (
      !(endHour === 0 && endMinute === 0) && // เงื่อนไขยกเว้น
    ...
    if (minutes < 0) minutes += 24 * 60;  // คำนวณเมื่อ end time ข้ามวัน
