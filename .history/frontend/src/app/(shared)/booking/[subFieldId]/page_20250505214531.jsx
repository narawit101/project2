...
export default function Booking() {
  ...
  function isSlotBooked(slot) {
    ...
    for (let booking of bookedSlots) {
      ...
      const [bookStartHour, bookStartMinute] = booking.start_time.split(":").map(Number);
      const [bookEndHour, bookEndMinute] = booking.end_time.split(":").map(Number);
  ...
  function calculateSelectedTimes() {
    ...
    // ❌ ถ้าสิ้นสุดเลยเที่ยงคืน (มากกว่า 00:00) ไม่ให้จอง
