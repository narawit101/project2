      ...
      <div className="container-bookings">
        ...
        <div className="book-sider">
          <div className="book-sum-box">
            ...
            <strong>เวลาคงเหลือ: {formatTime(timeLeft)} นาที</strong>
        ...
        {showModal && (
          <div className="modal-overlay-confirmbooking">
            <div className="modal-box-confirmbooking">
              <h3>ยืนยันการจอง</h3>
              <p>คุณแน่ใจหรือไม่ว่าต้องการจองเวลานี้?</p>
              ...
              <div className="book-owner-info">
                ...
                <div className={`total-box ${canBook ? "show" : ""}`}>
                  ...
                  <button onClick={validateBeforeSubmit } className="btn-submit-book">
                    จอง
                  </button>
                ...
                <button onClick={handleConfirm} className="btn-confirm-confirmbooking">
                  ยืนยัน
                </button>
                <button onClick={handleCancel} className="btn-cancel-confirmbooking">
                  ยกเลิก
                </button>
              </div>
            </div>
