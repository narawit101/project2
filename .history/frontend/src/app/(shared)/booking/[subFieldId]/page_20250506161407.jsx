    ...
    <div>
      ...
      <div className="container-bookings">
        ...
        <div className="book-sider">
                ...
                <strong>สนาม</strong> {fieldName}
    
          {subFieldData !== "ไม่พบข้อมูล" ? (
            <div className="detail-calendar">
              <p className="sub-name">
                <strong>สนาม</strong> {subFieldData.sub_field_name}
              </p>
              <p className="price">
                <strong>ราคา/ชม.</strong> {subFieldData.price} บาท
              </p>
              <p className="type">
                <strong>กีฬา</strong> {subFieldData.sport_name}
              </p>
            </div>
          ) : (
            <p>{subFieldData}</p>
