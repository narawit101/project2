          ...
          <div className="book-sum-box">
            ...
            <div className="facility-wrapper">
              ...
              {showFacilities && (
                <div className="facilities-list">
                  {facilities.map((fac) => (
                    <div key={fac.field_fac_id} className="facility-item">
                      <input
                        type="checkbox"
                        checked={
            ...
            <input
              ...
              onChange={(e) => {
                const file = e.target.files[0];
                if (file) {
                  setSelectedFileName(file.name); // ตั้งค่าชื่อไฟล์ใน state
                  handleimgChange(e); // เรียกฟังก์ชันเดิมของคุณ
                }
              }}
              accept="image/*"
            ...
            {selectedFileName && (
              <span className="uploaded-filename">{selectedFileName}</span>
            )}
