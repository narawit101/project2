  ...
  return (
    ...
    {selectedImage && (
        <div className="lightbox-overlay" onClick={handleCloseLightbox}>
          <button onClick={(e) => { e.stopPropagation(); handleLightboxPrev(); }} className="lightbox-arrow left" style={{ fontSize: '30px', padding: '12px', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '50%' }}>❮</button>
          <img src={selectedImage} alt="Zoomed" className="lightbox-image" />
          <button onClick={(e) => { e.stopPropagation(); handleLightboxNext(); }} className="lightbox-arrow right" style={{ fontSize: '30px', padding: '10px', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '50%' }}>❯</button>
        </div>
      )}
      {fieldData?.img_field ? (
