  ...
  return (
    ...
    {selectedImage && (
        <div className="lightbox-overlay" onClick={handleCloseLightbox}>
          <button onClick={(e) => { e.stopPropagation(); handleLightboxPrev(); }} className="lightbox-arrow left" style={{ fontSize: '35px', padding: '8px', backgroundColor: '#007bff', color: 'white', border: 'none' }}>❮</button>
          <img src={selectedImage} alt="Zoomed" className="lightbox-image" />
          <button onClick={(e) => { e.stopPropagation(); handleLightboxNext(); }} className="lightbox-arrow right" style={{ fontSize: '35px', padding: '8px',padding: '8px', backgroundColor: '#007bff', color: 'white', border: 'none' }}>❯</button>
        </div>
      )}
      {fieldData?.img_field ? (
