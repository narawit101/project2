  ...
  return (
    ...
    {selectedImage && (
        <div className="lightbox-overlay" onClick={handleCloseLightbox}>
          <button onClick={(e) => { e.stopPropagation(); handleLightboxPrev(); }} className="lightbox-arrow left" style={{ fontSize: '35px', padding: '8px',margin: '10px' backgroundColor: '#007bff', color: 'white', border: 'none' }}>❮</button>
