  ...
  return (
    ...
    {selectedImage && (
        <div className="lightbox-overlay" onClick={handleCloseLightbox}>
          <button onClick={(e) => { e.stopPropagation(); handleLightboxPrev(); }} className="lightbox-arrow left" style={{ fontSize: '30px', padding: '8px', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '50%' }}>❮</button>
