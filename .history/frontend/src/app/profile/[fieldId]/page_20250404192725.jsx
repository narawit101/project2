  ...
  return (
    ...
    {selectedImage && (
        <div className="lightbox-overlay" onClick={handleCloseLightbox}>
          <button onClick={(e) => { e.stopPropagation(); handleLightboxPrev(); }} className="lightbox-arrow left" style={{ fontSize: '35px', padding: '8px', backgroundColor: 'none', color: 'white', border: 'none', borderRadius: '50%' }}>❮</button>
