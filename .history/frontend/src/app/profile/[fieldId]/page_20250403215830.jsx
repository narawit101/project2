...
export default function CheckFieldDetail() {
  ...
  <div className="post-detail">
    <div className="post-card">
      <img src="path_to_image1.jpg" alt="Post Image 1" className="post-image" />
      <h2 className="post-title">หัวข้อโพส 1</h2>
      <p className="post-text">totam atque quidem culpa! Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
    </div>

    <div className="post-card">
      <img src="path_to_image2.jpg" alt="Post Image 2" className="post-image" />
      <h2 className="post-title">หัวข้อโพส 2</h2>
      <p className="post-text">totam atque quidem culpa! Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    </div>

    <div className="post-card">
      <img src="path_to_image3.jpg" alt="Post Image 3" className="post-image" />
      <h2 className="post-title">หัวข้อโพส 3</h2>
      <p className="post-text">totam atque quidem culpa! Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
    </div>
