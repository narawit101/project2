...
export default function MyCalendar() {
  ...
  const [errorMessage, setErrorMessage] = useState(""); // สถานะสำหรับแสดงข้อความผิดพลาด
   ...
   const handleDateConfirm = () => {
    if (date) {
      ...
      if (opendays.includes(day)) {
        ...
        // หากไม่ใช่วันเปิดให้แสดงข้อความผิดพลาด
        setErrorMessage("ไม่สามารถเลือกวันหยุดนี้ได้");
      }
    }
  };
