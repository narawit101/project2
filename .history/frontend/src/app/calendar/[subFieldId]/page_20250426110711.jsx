        ...
        .then((data) => {
          if (data.error) {
            ...
            if (data[0] && data[0].open_days) {
              ...
              setFieldData(data[0].sub_fields[0].sub_field_name);
              console.log("ข้อมูลสนาม", data);
              console.log("ข้อมูลสนาม", data[0].sub_fields[0].sub_field_name);
  ...
  return (
    <div>
      ...
      <div className="sub-fields-container">
            <h1>สนามย่อย</h1>
            {fieldData?.sub_fields.subfield_name && fieldData.sub_fields.subfield_name.length > 0 ? (
