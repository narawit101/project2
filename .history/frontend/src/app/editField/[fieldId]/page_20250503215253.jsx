        ...
        <div className="field-details-editfield">
          <div className="input-group-editfield">
            ...
            {editingField === "field_name" ? (
              <>
                ...
                <button className="canbtn-editfield-editfield" onClick={cancelEditing}>
                  ยกเลิก
                </button>
              </>
            ) : (
          ...
          {editingField === "img_field" ? (
            <div className="preview-container">
              ...
              <button className="savebtn-editfield" onClick={saveImageField}>
                บันทึก
              </button>
              <button className="canbtn-editfield" onClick={cancelEditing}>
                ยกเลิก
            ...
            {editingField === "documents" ? (
              <>
                <input
                  ...
                  accept="image/*,.pdf"
                />
                <button className="savebtn-editfield" onClick={saveDocumentField}>
                  บันทึก
                </button>
                <button className="canbtn-editfield" onClick={cancelEditing}>
                  ยกเลิก
                        ...
                        <p key={`${sub.sub_field_id}-${addon.add_on_id}`}>
                          {editingAddon.addOnId === addon.add_on_id ? (
                            <>
                              ...
                              />
                              <button className="savebtn-editfield" onClick={saveAddon}>
                                บันทึก
                              </button>
                              <button
                                className="canbtn-editfield"
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              <button className="savebtn-editfield" onClick={confirmDeleteSubField}>
                ยืนยัน
              </button>
              <button
                className="canbtn-editfield"
      ...
      {showDeleteAddOnModal && (
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              <button className="savebtn-editfield" onClick={confirmDeleteAddOn}>
                ยืนยัน
              </button>
              <button
                className="canbtn-editfield"
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              <button className="savebtn-editfield" onClick={() => setShowModal(false)}>
                ยกเลิก
              </button>
              <button className="canbtn-editfield-editfield" onClick={handleDeleteFacility}>
                ลบ
              </button>
            </div>
          </div>
