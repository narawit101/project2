...
export default function CheckFieldDetail() {
  ...
  const addSubField = async (userId) => {
    ...
    if (response.ok) {
      ...
      C:\D\project\fronten…eldId]\page.jsx:385 
 POST http://localhost:5000/field/subfield/156 400 (Bad Request)
addSubField	@	C:\D\project\fronten…eldId]\page.jsx:385
onClick	@	C:\D\project\fronten…ldId]\page.jsx:1371
