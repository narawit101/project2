  ...
  return (
    <>
      ...
      <div className="homepage">
        ...
        <div className="banner-postData">

      {postData.length > 0 ? (
        <>
                <h2 className="post-title">{postData.content}</h2>
          <img
            src={postData[currentIndex].image_url}
            alt={postData[currentIndex].name}
            className="carousel-img"
            onClick={() => router.push(postData[currentIndex].link)}
          />
          <div className="dots">
