              ...
              <li key={index} className="booking-card">
                <div className="booking-detail">
                  ...
                  <div className="price-container-my-order">
                    <strong className="activity-label">{item.activity}</strong>

                    {/* มัดจำ */}
                    <div className="price-deposit-order">
                      <p>
                        <strong>มัดจำ:</strong> {item.price_deposit} บาท
                      </p>
                    </div>
                    ...
                    {Array.isArray(item.facilities) &&
                      item.facilities.length > 0 && (
                        <div className="facility-container-order">
                          <strong>สิ่งอำนวยความสะดวก:</strong>
                          <ul className="facility-list-order">
                          ...
                          <p>
                            <strong>
                              ราคาหลังหักค่ามัดจำ: {getFacilityNetPrice(item)}{" "}
                              บาท
                            </strong>
                          </p>
                        </div>
                    ...
                    {(!item.facilities || item.facilities.length === 0) && (
                      <div className="no-facility-price">
                        <p>
                    ...
                    <div className="total-remaining-order">
                      <p>
                        <strong>ราคารวมสุทธิ:</strong> {item.total_price} บาท
                      </p>
                    </div>
                  </div>
