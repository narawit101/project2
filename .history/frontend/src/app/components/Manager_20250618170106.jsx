...
export default function AdminManager() {
  ...
  const DeleteFieldModal = ({ fieldId, onDelete, onClose }) => (
    <div classNameName="confirm-modal-field">
      <div classNameName="modal-content-field">
        <p>คุณแน่ใจหรือไม่ว่าต้องการลบสนามกีฬานี้?</p>
        <div classNameName="modal-actions-field">
          <button
            classNameName="confirmbtn-field"
            onClick={() => onDelete(fieldId)}
          >
            ยืนยัน
          </button>
          <button classNameName="cancelbtn-field" onClick={onClose}>
            ยกเลิก
          </button>
        </div>
      </div>
  ...
  const DeleteUserModal = ({ userId, onDelete, onClose }) => (
    <div classNameName="confirm-modal-user">
      <div classNameName="modal-content-user">
        <p classNameName="comfirm-message">คุณแน่ใจหรือไม่ว่าต้องการลบผู้ใช้นี้?</p>
        <div classNameName="modal-actions-user">
          <button classNameName="confirmbtn-user" onClick={() => onDelete(userId)}>
            ยืนยัน
          </button>
          <button classNameName="cancelbtn-user" onClick={onClose}>
            ยกเลิก
          </button>
          {startProcessLoad && (
            <div classNameName="loading-overlay">
  ...
  //       <span classNameName="spinner"></span>
  //     </div>
  //   );
  ...
  return (
    <>
      {message && (
        <div classNameName={`message-box ${messageType}`}>
          <p>{message}</p>
        </div>
      )}
      <div classNameName="admin-manager-container">
        <h2 classNameName="Title">รายชื่อผู้ใช้งาน</h2>
        <h3 classNameName="Head">ผู้ดูแลระบบ</h3>
        {dataLoading && (
          <div classNameName="loading-data">
            <div classNameName="loading-data-spinner"></div>
          </div>
        )}
        <table classNameName="manager-table">
          <thead>
            <tr>
              <th>id</th>
              <th>ชื่อ</th>
        ...
        {/* ตารางสำหรับลูกค้า */}
        <h3 classNameName="Head">ผู้ใช้ทั้งหมด</h3>
        <div classNameName="filter-role-container">
          <select
            value={roleFilter}
            onChange={(e) => {
        ...
        <table classNameName="manager-table-user">
          <thead>
            <tr>
              <th>ID</th>
              <th>ชื่อ-สกุล</th>
        ...
        <div classNameName="pagination">
          {Array.from(
            ...
            (_, i) => (
              <button
                key={i}
                classNameName={currentPage === i + 1 ? "active" : ""}
        ...
        {selectedUser && (
          <div classNameName="modal-manager">
            <div classNameName="modal-content-manager">
              <h3 classNameName="Head">แก้ไขข้อมูลลูกค้า</h3>
              <form onSubmit={handleUpdateUser}>
                ...
                <div classNameName="modal-buttons">
                  <button type="submit" classNameName="save-btn-manager">
                    บันทึก
                  </button>
                  <button
                    type="button"
                    classNameName="cancel-btn-manager"
                    onClick={closeModal}
                  >
                    ยกเลิก
                  </button>
