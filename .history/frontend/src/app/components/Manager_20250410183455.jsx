...
export default function AdminManager() {
    ...
    <>
      ...
      <div className="admin-manager-container">
        ...
        <table>
          ...
          <tbody>
            {users
              .filter((user) => user.role === "customer" || user.role === "field_owner")
              .map((user) => (
                <tr key={user.user_id}>
                  <td>
                    {user.first_name} - {user.last_name}
                  ...
                  <td>
  {
    ...
    user.role === "field_owner" ? "เจ้าของสนาม" :
    user.role // ถ้าไม่ใช่ customer หรือ field_owner ให้แสดงเป็น role เดิม
  }
</td>
                  <td>
                    <button
