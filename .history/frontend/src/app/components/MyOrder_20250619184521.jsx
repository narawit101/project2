...
<div className="hours-container-my-order">
  <div className="total-hours-order">
    ...
    <p>
      <strong>ยกเลิกก่อนเวลาเริ่ม:</strong> {item.cancel_hours} ชม.
    </p>
  </div>
  <div className="total-date-order">
    <p>
      <strong>ยกเลิกได้ถึง:</strong>
    </p>
    <p style={{ marginLeft: "1rem" }}>
      วันที่: {formatDate(item.start_date)}
    </p>
    <p style={{ marginLeft: "1rem" }}>
      เวลา: {getCancelDeadlineTime(item.start_date, item.start_time, item.cancel_hours)} น.
    </p>
  </div>
</div>
