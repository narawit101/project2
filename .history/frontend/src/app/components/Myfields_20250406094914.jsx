    ...
    const fetchMyFields = async () => {
      try {
        ...
        if (data && data.length > 0) {
          // ตรวจสอบสถานะของทุกสนาม
          const hasPendingStatus = data.some((field) => field.status === "รอตรวจสอบ");
          setCanEdit(!hasPendingStatus);  // ถ้ามีอย่างน้อยหนึ่งสนามที่สถานะ "รอตรวจสอบ" จะตั้งค่าให้เป็น false
        }
