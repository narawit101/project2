...
export default function Register() {
  ...
  // ตรวจสอบความยาวและความแข็งแกร่งของรหัสผ่าน
  ...
  const handleSubmit = async (e) => {
    ...
    // ตรวจสอบความตรงกันของรหัสผ่านและการยืนยันรหัส
    if (formData.password !== formData.confirmPassword) {
      newErrors.passwordMatch = "รหัสผ่านและการยืนยันรหัสไม่ตรงกัน";
    }

    // ตรวจสอบการซ้ำซ้อนของชื่อผู้ใช้และอีเมล
    ...
    // หากมีข้อผิดพลาด จะหยุดการส่งข้อมูล
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="input-group">
          ...
          {errors.passwordLength && (
            <p className="error-message">{errors.passwordLength}</p>
          )}
        </div>
