    ...
    {booking.map((item, index) => (
      <li key={index} className="booking-card">
        <div className="booking-detail">
          <p><strong>ชื่อผู้จอง: </strong>{userInfo}</p>
          <p><strong>วันที่จอง: </strong>{formatDate(item.start_date)}</p>
          ...
          <div className="hours-container-my-order">
            <div className="total-hours-order">
              ...
              <p><strong> สามารถยกเลิกก่อนเวลาเริ่ม: </strong>{item.cancel_hours} ชม.</p>
            </div>
            <div className="total-date-order">
              <p>ยกเลิกได้ถึง <strong>วันที่:</strong> {formatDate(item.start_date)} <br />
              <strong> ** เวลา:</strong> {getCancelDeadlineTime(item.start_date, item.start_time, item.cancel_hours)} น. **</p>
            </div>
          </div>
          ...
          <div className="price-container-my-order">
            ...
            <div>
              <p><strong>ราคาหลังหักค่ามัดจำ: </strong>{item.total_remaining} บาท</p>
            </div>
            <div className="total-remaining-order">
              <p><strong>ราคารวมสุทธิ: </strong>{item.total_price} บาท</p>
            </div>
          </div>
