...
import { faHouse } from '@fortawesome/free-solid-svg-icons';       // นำเข้าไอคอนที่ต้องการใช้งาน
        ...
        <div className="user-profile"></div>
          ...
          >
            ...
            <div className="dropdown" ref={dropdownRef}>
              <ul>
                {user.role === "customer" &&  <li><a href="/editprofile">แก้ไขโปรไฟล์</a><FontAwesomeIcon icon={faHouse} /></li>}
