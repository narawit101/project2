          ...
          >
            ...
            <div className="dropdown" ref={dropdownRef}>
              <ul>
                ...
                {user?.role === "admin" && <li><Link href="/admin/manager">จัดการผู้ใช้</Link></li>}
                {user?.role === "admin" && <li><Link href="/myfield">จัดการสนามกีฬา</Link></li>}
                {user?.role === "admin" && <li><Link href="/admin/addfac">จัดการสิ่งอำนวยความสะดวก</Link></li>}
                {user?.role === "admin" && <li><Link href="/admin/addtype">จัดการประเภทกีฬา</Link></li>}
                <LogoutButton />
              </ul>
            </div>
          </div>
