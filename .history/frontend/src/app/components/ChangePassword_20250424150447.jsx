...
export default function ChangePassword() {
  ...
  const handlePasswordChange = async (e) => {
    ...
    if (!passwordRegex.test(newPassword)) {
      setMessage("รหัสผ่านต้องประกอบด้วยตัวอักษรพิมพ์ใหญ่, พิมพ์เล็ก, ตัวเลข และอักขระพิเศษ");
      setMessageType("error");
    } else {
      setMessage("รหัสผ่านแข็งแรง");
      setMessageType("success");
    }
    if (!passwordRegex.test(confirmPassword)) {
      setMessage("รหัสผ่านใหม่ต้องประกอบด้วยตัวอักษรพิมพ์ใหญ่, พิมพ์เล็ก, ตัวเลข และอักขระพิเศษ");
      setMessageType("error");
    } else {
      setMessage("รหัสผ่านแข็งแรง");
      setMessageType("success");
