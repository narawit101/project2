              ...
              <li key={index} className="booking-card">
                <div className="booking-detail">
                  ...
                  <div className="compact-price-box">
                    ...
                    <div className="line-item remaining">
                      <span className="total-remaining-order">รวมที่ต้องจ่าย(ยอดคงเหลือ):</span>
                      <span className="total-remaining-order">รวมที่ต้องจ่าย(ยอดคงเหลือ):</span>
                      <span className="total-remaining-order">{item.total_remaining} บาท</span>
                    </div>
