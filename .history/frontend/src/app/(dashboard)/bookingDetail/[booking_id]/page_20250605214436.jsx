...
export default function BookingDetail() {
  ...
  const closeConfirmModal = () => {
    setDisabledButtons({ approved: false, rejected: false });
  ...
  return (
    <div className="order-detail">
      ...
      {!booking || Object.keys(booking).length === 0 ? (
        ...
        <li className="booking-card-order-detail">
          ...
          <div className="deposit-slip-container-order-detail">
            ...
            {booking.deposit_slip || booking.total_slip ? (
              ...
              <p className="no-slip-message">ไม่จ่ายค่าต้องมัดจำ</p>
            )}
          </div>
       ...
       {user?.user_id === booking.field_user_id && booking.status === "pending" && (
  <div className="status-buttons-order-detail">
    {!hiddenButtons.approved && (
      <button
        className="approve-btn-order-detail"
        onClick={() => {
          setHiddenButtons((prev) => ({ ...prev, approved: true }));
    ...
    {!hiddenButtons.rejected && (
      <button
        className="reject-btn-order-detail"
        onClick={() => {
          setHiddenButtons((prev) => ({ ...prev, rejected: true }));
