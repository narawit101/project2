    ...
    <div className="order-detail">
      ...
      {!booking || Object.keys(booking).length === 0 ? (
        ...
        <li className="booking-card-order-detail">
          ...
          <p>
            <strong>ราคาหลังหักค่ามัดจำ:</strong> {booking.total_remaining} บาท
          </p>
          <p>
          ...
          <div className="deposit-slip-container-order-detail">
            ...
            {booking.deposit_slip ? (
              ...
              booking?.user_id === user?.user_id ? (
                <div>
                  <p className="no-slip-message">กรุณาจ่ายค่ามัดจำ</p>
                  <p>จ่ายมัดจำ</p>
                  <input
                    type="file"
                    accept="image/*"
              ...
              <p className="no-slip-message">ไม่ต้องแนบสลิปมัดจำ</p>
            )}
          </div>
