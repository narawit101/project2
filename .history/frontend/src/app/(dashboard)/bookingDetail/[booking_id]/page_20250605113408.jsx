...
const calTotalHours = (total_hours) => {
  ...
  const minutes = Math.round((total_hours % 1) * 60); // ✅ ใช้ *60 แทน *100
  const formattedMinutes = minutes.toString().padStart(2, "0");
  return `${hour}:${formattedMinutes}`; // ไม่ใส่ "ชม." ตรงนี้
};
    ...
    <div className="order-detail">
      ...
      {!booking || Object.keys(booking).length === 0 ? (
        ...
        <li className="booking-card-order-detail">
          ...
          <p>
            <strong>ชั่วโมงรวม:</strong> {calTotalHours(booking.total_hours)} ชม.
          </p>
          <p>
