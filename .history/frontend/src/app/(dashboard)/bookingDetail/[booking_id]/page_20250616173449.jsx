...
export default function BookingDetail() {
  ...
  const getStatusLabel = (status) => {
    switch (status) {
      ...
      case "complete":
        return { text: "จองเสร็จสมบูรณ์", className: "status-complete" };
      default:
      ...
      <div className="order-detail">
        ...
        {dataLoading ? (
          ...
          <li className="booking-card-order-detail">
            ...
            {showReviewModal && (
              <div className="modal-overlay-order-detail-reviwe">
                <div className="modal-content-detail-reviwe">
                  <h3>ให้คะแนนการจองสนาม</h3>
