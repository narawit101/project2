...
export default function BookingDetail() {
  ...
  const [canNotApproved, SetCanNotAppreced] = useState(false);
          ...
          <li className="booking-card-order-detail">
            ...
            {user?.user_id === booking.field_user_id && (
              <div className="status-buttons-order-detail">
                {/* แสดงปุ่มอนุมัติเฉพาะถ้ายังไม่ได้อนุมัติ */}
                {booking?.status !== "approved" && (
                  <button
                ...
                {/* แสดงปุ่มไม่อนุมัติเสมอ ถ้ายังไม่ได้ "rejected" */}
                {booking?.status !== "rejected" && (
                  <button
