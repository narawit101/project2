...
export default function BookingDetail() {
  ...
  {/* ยกเลิกได้ถึง */}
  <div className="line-item cancel-info">
    <span>ยกเลิกได้ถึง:</span>
    <span>
      {formatDate(booking.start_date)}<br />
      เวลา: {getCancelDeadlineTime(booking.start_date, booking.start_time, booking.cancel_hours)} น.
    </span>
  </div>
</div>
            ...
            <div className="booking-detail-box">
              ...
              {Array.isArray(booking.facilities) && (
                <>
                  ...
                  <div className="line-item-detail">
                    <span className="all-price-detail">รวมราคาสิ่งอำนวยความสะดวก:</span>
                    <span className="all-price-detail">
                      {booking.facilities.reduce(
                        (sum, f) => sum + f.fac_price,
                        0
              ...
              <div className="line-item-detail highlight">
                <span className="total-remianing-detail">รวมที่ต้องจ่าย: (ยอดคงเหลือ)</span>
