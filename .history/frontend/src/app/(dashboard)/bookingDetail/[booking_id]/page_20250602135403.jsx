  ...
  <li className="booking-card">
    ...
    {user?.role === "field_owner" && (
      <div className="status-buttons">
        <button className="approve-btn" onClick={() => openConfirmModal("approved")}>ผ่านการอนุมัติ</button>
        <button className="reject-btn" onClick={() => openConfirmModal("rejected")}>ไม่ผ่านการอนุมัติ</button>
      </div>
    )}
    ...
    <button className="cancel-booking-btn" onClick={() => cancelBooking(booking.booking_id)}>
      ยกเลิกการจอง
    </button>
  </li>
)}
