...
app.use(
  cors({
    origin: allowedOrigins, 
    credentials: true, // สำคัญ: ต้องเป็น true เพื่อส่ง cookies
    methods: ["GET", "POST", "PUT", "DELETE", "PATCH", "OPTIONS"],
    allowedHeaders: [
      "Content-Type", 
      "Authorization", // เพิ่มสำหรับ JWT token
      "Cookie",        // เพิ่มสำหรับ cookies
      "Set-Cookie",    // เพิ่มสำหรับ set cookies
      "X-Requested-With"
    ],
    exposedHeaders: ["Set-Cookie"], // อนุญาตให้ client อ่าน Set-Cookie header
  })
);
