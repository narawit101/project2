...
app.use('/uploads/images', express.static(path.join(__dirname, 'uploads/images/field-profile')));
app.use('/uploads/images/posts', express.static(path.join(__dirname, 'uploads/images/posts')));
app.use('/uploads/images/posts/slip', express.static(path.join(__dirname, 'uploads/images/posts')));
