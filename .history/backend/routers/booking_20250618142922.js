          ...
          if (!bookingData.field_owner_email) {
            ...
            try {
              const emailRes = await resend.emails.send({
                ...
                html: ` <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: auto; padding: 20px; background-color: #f9fafb; border-radius: 8px; border: 1px solid #e5e7eb;">
