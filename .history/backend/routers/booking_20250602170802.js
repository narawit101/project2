...
router.delete(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // ✅ ป้องกัน error: ตรวจสอบและแปลง start_date เป็น Date object
      let startDateStr;
      try {
      ...
      if (cancel_hours === null) {
        ...
        // ✅ รวมเวลา startDate + start_time และปรับเป็นเวลาไทย
        const startDateTime = new Date(`${startDateStr}T${start_time}:00Z`);
