...
`);
       ...
       WHERE b.booking_id = $1`,
        ...
        if (userInfo) {
          ...
          <p>การจองสนาม <strong>${userInfo.field_name}</strong> ของคุณได้รับการอนุมัติแล้ว</p>
            <a href="${process.env.FONT_END_URL}/bookingDetail/${booking_id}">แนบสลิป(กรุณาแนบสลิป ภายใน 1 ชม. หลังจากอนุมัติ)</a>
  ...
  <p>
    <a href="${process.env.FONT_END_URL}/bookingDetail/${booking_id}">
