...
router.post("/post",authMiddleware,upload.array("img_url"),async (req, res) => {
    ...
    try {
      ...
      const user_id = req.users.user_id; // Get the authenticated user's ID
      ...
      const newPost = await client.query(
        `INSERT INTO posts (title, content, field_id, user_id) VALUES ($1, $2, $3, $4) RETURNING post_id`, // Include user_id
        [title, content, field_id, user_id]
      );
