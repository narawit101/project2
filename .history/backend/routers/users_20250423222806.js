...
router.post("/reset-password", async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "ส่ง OTP ใหม่ ไปยังอีเมลเรียบร้อยแล้ว", user_id: user.user_id,
...
router.post("/resent-reset-password", async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "ส่ง OTP ไปยังอีเมลเรียบร้อยแล้ว", user_id: user.user_id,
      user_name: user.user_name,
      first_name: user.first_name,
      last_name: user.last_name,
      email: user.email,
